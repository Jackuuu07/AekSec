...
import { FiEye, FiMessageSquare, FiThumbsUp, FiUsers, FiSearch, FiChevronLeft, FiChevronRight, FiUser } from "react-icons/fi";
...
export default function Community() {
  ...
  const featured = [
    ...
    {
      title: "Meet Hideyuki Osaki – KalpTech Expert Spotlight",
    ...
    {
      title: "Celebrating 5 years of KalpTech Community",
    ...
    {
      title: "Welcome to the KalpTech Community – Getting Started",
  ...
  const activities = [
    ...
    },
    {
      ...
      likes: 0,
      category: "Security",
      desc: "Greetings everyone, I'm new with KalpTech Firewall Management Center...",
    },
  ];
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          <p className="text-gray-200 max-w-3xl mb-8">
            A hub to connect with peers and KalpTech specialists, ask questions,
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="w-10 h-10 border rounded-full hover:bg-gray-100 flex items-center justify-center"
            >
              <FiChevronLeft />
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-gray-600">
              KalpTech Community is an active place to learn, collaborate, and
