...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Chatbot Window */}
      {isOpen && (
        <div className="flex flex-col w-96 h-[600px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
          {/* Header */}
            ...
            <div className="flex items-center space-x-2">
              <div className="flex-1 relative">
                <textarea
                  ...
                  className="w-full p-3 pr-10 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-sm"
                  rows="1"
                />
