                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                            <div className="lg:w-2/3">
                                ...
                                <p className="text-xl text-gray-600 max-w-4xl leading-relaxed mb-10">
                                    KalpTechis pioneering the critical infrastructure required to securely power the next generation of artificial intelligence. 
                                ...
                                <div className="flex flex-wrap gap-6 mt-12">
                                    <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-xl shadow-sm border">
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                                Founded in 2022 by a team of cybersecurity veterans and AI researchers, KalpTechemerged from a simple observation: 
                        ...
                        <div className="grid md:grid-cols-3 gap-10">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    ...
                                    KalpTechhas become the standard for secure AI infrastructure in regulated industries.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-20">
                            <div className="bg-gradient-to-br from-blue-50 to-white p-10 rounded-3xl shadow-xl border border-blue-100">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-8 text-lg">
                                    KalpTechenables businesses to innovate faster while maintaining strong security posture, 
                            ...
                            <div className="bg-gradient-to-br from-indigo-50 to-white p-10 rounded-3xl shadow-xl border border-indigo-100">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                                    ...
                                    KalpTechaims to become the foundational layer for AI-native enterprises worldwide—the 
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-4xl font-bold mb-8 flex items-center gap-4">
                                    ...
                                    <span>Careers at AekSec</span>
                                </h2>
                                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                                    At AekSec, we're assembling a world-class team of engineers, researchers, designers, 
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-white p-10 rounded-3xl shadow-xl border border-blue-100">
                                ...
                                <div className="space-y-4">
                                    <div className="p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                                    ...
                                    <div className="p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            <span className="px-3 py-1 bg-blue-100 text-blue-800 text-sm rounded-full">San Francisco</span>
                                            <span className="px-3 py-1 bg-green-100 text-green-800 text-sm rounded-full">Full-time</span>
                                        </div>
                                    </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-16">
                            <div>
                                ...
                                <div className="space-y-6 mb-12">
                                    <div className="flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                                        <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                                            <Mail className="text-blue-600" size={22} />
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-lg">General Inquiries</h4>
                                            <p className="text-gray-600">contact@aeksec.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">support@aeksec.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">research@aeksec.com</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-white p-6 rounded-2xl border border-blue-100">
                                    ...
                                    <p className="text-gray-600">San Francisco, CA • New York, NY • London, UK • Remote Teams Worldwide</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-white p-10 rounded-3xl shadow-xl border border-blue-100">
                                ...
                                <form className="space-y-6">
                                    ...
                                    <button type="submit" className="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg">
                                        Send Message
                                    </button>
                                </form>
                            </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="bg-gradient-to-br from-indigo-50 to-white p-10 rounded-3xl shadow-xl border border-indigo-100">
                                <h2 className="text-4xl font-bold mb-8 flex items-center gap-4">
                                    ...
                                    <span>Connect with AekSec</span>
                                </h2>
                                
                                <p className="text-lg text-gray-600 leading-relaxed mb-10">
                                    Stay connected with KalpTechto receive product updates, cutting-edge research insights, 
                                    security advisories, and announcements about the future of AI infrastructure security.
                                </p>
                                
                                <div className="grid grid-cols-2 gap-6">
                                    <a href="#" className="p-5 bg-white rounded-xl border border-gray-200 hover:border-indigo-300 hover:shadow-lg transition-all flex flex-col items-center justify-center text-center group">
                                        ...
                                        <span className="text-sm text-gray-500 mt-1">Company updates & careers</span>
                                    </a>
                                    
                                    <a href="#" className="p-5 bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all flex flex-col items-center justify-center text-center group">
                                        ...
                                        <span className="text-sm text-gray-500 mt-1">Security insights & news</span>
                                    </a>
                                    
                                    <a href="#" className="p-5 bg-white rounded-xl border border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all flex flex-col items-center justify-center text-center group">
                                        ...
                                        <span className="text-sm text-gray-500 mt-1">Technical deep dives</span>
                                    </a>
                                    
                                    <a href="#" className="p-5 bg-white rounded-xl border border-gray-200 hover:border-red-300 hover:shadow-lg transition-all flex flex-col items-center justify-center text-center group">
                                        ...
                                        <span className="text-sm text-gray-500 mt-1">Monthly insights & updates</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <div className="p-5 bg-gradient-to-r from-white to-blue-50 rounded-xl border border-blue-100">
                                        <h4 className="font-bold text-lg mb-2">KalpTechSecurity Summit</h4>
                                    ...
                                    <div className="p-5 bg-gradient-to-r from-white to-purple-50 rounded-xl border border-purple-100">
                                        ...
                                        <span className="text-sm text-purple-600 font-medium">Every third Wednesday at 10am PT</span>
                                    </div>
                                    
                                    <div className="p-5 bg-gradient-to-r from-white to-green-50 rounded-xl border border-green-100">
                                        ...
                                        <span className="text-sm text-green-600 font-medium">GitHub: github.com/aeksec</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-24 px-10 bg-gradient-to-b from-white to-blue-50">
                    <div className="max-w-6xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto mb-12">
                            Your feedback is instrumental in shaping the future of AekSec. We actively listen to our customers, 
                ...
                <section className="py-24 px-10 bg-gradient-to-b from-gray-100 to-gray-200">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    ...
                                    transparent policies and strong technical and organizational safeguards. Our privacy 
                                    framework is designed to exceed global standards including GDPR, CCPA, and emerging AI regulations.
                                </p>
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    KalpTechmaintains industry-leading security certifications including SOC 2 Type II, 
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    ...
                                    and customer support resources to get the most out of KalpTechproducts. Our technical 
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    By using KalpTechservices, you agree to our terms governing platform usage, security 
                        ...
                        <div className="mt-16 pt-10 border-t border-gray-300 text-center text-gray-600">
                            <p className="mb-4">© 2024 KalpTechTechnologies, Inc. All rights reserved.</p>
