...
export default function Career() {
  const openPositions = [
    {
      ...
      experience: "5+ years",
      description:
        "Design and implement enterprise security solutions for Indian and global clients",
    ...
    },
    {
      ...
      experience: "3+ years",
      description:
        "Monitor, analyze, and respond to security incidents in our 24/7 SOC",
    ...
    },
    {
      ...
      experience: "7+ years",
      description:
        "Design secure cloud infrastructure for AWS, Azure, and GCP environments",
    ...
    },
    {
      ...
      experience: "6+ years",
      description:
        "Lead product strategy for our security platforms targeting Indian enterprises",
    ...
    },
    {
      ...
      experience: "4+ years",
      description:
        "Integrate security into CI/CD pipelines and automate security processes",
    ...
    },
    {
      ...
      experience: "5+ years",
      description:
        "Guide enterprise clients on security best practices and compliance",
    ...
    },
    {
      ...
      experience: "4+ years",
      description:
        "Conduct security assessments and penetration testing for clients",
    ...
    },
    {
      ...
      experience: "3+ years",
      description:
        "Manage compliance programs and security policies for clients",
  ...
  const benefits = [
    {
      ...
      description:
        "Industry-standard salary with performance bonuses and ESOPs",
    },
    {
      icon: Trophy,
      title: "Career Growth",
    ...
    },
    {
      ...
      description:
        "Paid certifications (CISSP, CISM, CEH, CCSP) and training programs",
    },
    {
      icon: Heart,
  ...
  const applicationSteps = [
    {
      ...
      description: "Send your resume to hr@kalptechitsolutions.com",
    },
    {
      step: "02",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Join KalpTech IT Solutions - India's fastest growing cybersecurity
              company based in Ahmedabad
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="reveal py-16 px-6 bg-gray-100">
        <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Located in the heart of Ahmedabad's business district on SG
                  Highway, our modern office provides the perfect environment
                  for cybersecurity professionals to thrive.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                    <span>
                      State-of-the-art security operations center (SOC)
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                    <span>
                      Dedicated cybersecurity lab for research and testing
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  ...
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                    <span>
                      Easy access to public transport and ample parking
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {additionalPerks.map((perk, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl border border-gray-200 p-6 hover:border-blue-300 transition-all duration-300"
              >
      ...
      {/* Open Positions */}
      <section className="reveal py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4">
            <div>
              <h2 className="text-4xl font-bold text-gray-900">
                Open Positions in Ahmedabad
              </h2>
              <p className="text-gray-600 mt-2">
                Join our growing team of cybersecurity experts
              </p>
            </div>
      ...
      {/* Culture & Team */}
      <section className="reveal py-20 px-6 bg-slate-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">
            Life at KalpTech Ahmedabad
          </h2>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Our Ahmedabad Team Culture
              </h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                At KalpTech Ahmedabad, we blend the professionalism of a global
                cybersecurity company with the warmth of Gujarati hospitality.
                Our team enjoys a collaborative environment where knowledge
                sharing and innovation are celebrated.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Weekly security tech talks and training sessions
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Quarterly team outings and celebrations
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Regular knowledge sharing sessions on emerging threats
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
      ...
      <section className="reveal py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">
            Our Hiring Process in Ahmedabad
          </h2>
      ...
      {/* CTA Section */}
      <section className="reveal py-20 px-6 bg-blue-50">
        <div className="max-w-4xl mx-auto text-center text-black">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Start Your Cybersecurity Career in Ahmedabad?
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-6 border-t border-white/20">
              ...
              <p className="">
                Corporate Tower, SG Highway, Ahmedabad
              </p>
              <p className="">
