        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-slate-600 max-w-xl">
              Align yourself with the best of the best. KalpTech certifications are
