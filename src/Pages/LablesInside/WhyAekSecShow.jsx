...
const TABS = {
  "AI-ready data centers": {
    ...
    to the cloud, when speed and precision matter most, KalpTech provides the
  ...
  "Future-proofed workplaces": {
    ...
    KalpTech collaboration solutions enable real-time communication,
  ...
  "Digital resilience": {
    ...
    critical. KalpTech security and observability solutions help McLaren
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-slate-600">
            ...
            solutions from KalpTech to support real-time data analysis and gain a
...
export default function WhyAekShow() {
  return (
    <main className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            <h2 className="text-4xl font-light text-slate-900 mb-6">
              KalpTech makes the AI era work
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 border-l pl-16">
            <div>
              ...
              <p className="text-slate-600">
                KalpTech solutions set the bar for scale, reliability, and
            ...
            <div>
              ...
              <p className="text-slate-600">
                KalpTech’s platform approach unifies products into powerful systems
            ...
            <div>
              ...
              <p className="text-slate-600">
                Built on years of experience and data, KalpTech blends AI with
      ...
      <section className="bg-white">
        ...
        <div className="relative w-full h-[560px]">
          ...
          {/* SUBTLE IMAGE EFFECT (like KalpTech glow) */}
          ...
          <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div>
              <h4 className="text-lg font-medium mb-3">
                KalpTech AI Readiness Assessment
              </h4>
            ...
            <div>
              <h4 className="text-lg font-medium mb-3">
                KalpTech AI Readiness Index 2025
              </h4>
              <p className="text-white/80 mb-4 text-sm">
