...
export default function ProductandServiceShows() {
    ...
    <main className="w-full">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#07182d] to-[#0b2447] text-white py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <h1 className="text-5xl font-light mb-4">KalpTech products</h1>
          <p className="text-lg text-white/80 max-w-xl">
            Find the KalpTech products that fit your needs.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-2">
        ...
        "
          ...
          <img
            ...
            alt="KalpTech Validated Design Zone"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-blue-600">
                <li>KalpTech DNA</li>
                <li>KalpTech Feature Navigator</li>
                <li>KalpTech Software Central</li>
                <li>KalpTech Software Central</li>
