  ...
  const capabilities = [
    {
      ...
      description:
        "AI models that forecast threats and business outcomes with high accuracy.",
    ...
    },
    {
      ...
      description:
        "Process streaming data for immediate insights and responses.",
    ...
    },
    {
      ...
      description:
        "Automatically detect unusual patterns and potential threats.",
    ...
    },
    {
      ...
      description:
        "End-to-end platform for building, deploying, and managing ML models.",
  ...
  const useCases = [
    {
      ...
      solution:
        "Real-time transaction monitoring with AI-powered fraud scoring",
    ...
    },
    {
      ...
      solution:
        "Predictive models for patient risk stratification and treatment optimization",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              Advanced AI and machine learning platform that transforms data
              into actionable intelligence for smarter decision-making and
              predictive insights.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {capabilities.map((capability, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8"
              >
                <div
                  className={`p-4 rounded-xl bg-gradient-to-br ${capability.color} w-fit mb-6`}
                >
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            {/* Core Technologies */}
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-8 pb-3 border-b border-gray-200">
                Core Technologies
              </h3>
                ...
                {[
                  {
                    ...
                    desc: "Deep learning frameworks",
                  },
                  { name: "Apache Spark", desc: "Distributed data processing" },
                  { name: "Kubernetes", desc: "Container orchestration" },
                  {
                    name: "Elasticsearch",
                    desc: "Real-time search & analytics",
                  },
                  {
                    name: "PostgreSQL / Redis",
                    desc: "Data storage & caching",
                  },
                ].map((tech, index) => (
                  <div key={index} className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-2 h-2 bg-gray-800 rounded-full mt-2"></div>
                    <div>
      ...
      <section className="py-20 px-6 bg-blue-50">
        <div className="max-w-4xl mx-auto text-center text-black">
          ...
          <p className="text-xl opacity-90 mb-8">
            Start your journey with Kulp Intelligence. Request a personalized
            demo today.
          </p>
        </div>
      </section>
