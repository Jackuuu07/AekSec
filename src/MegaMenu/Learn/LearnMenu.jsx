  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          Find software, firmware, and drivers for all Cisco products. Access
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          Comprehensive technical documentation, configuration guides, release
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          Get expert assistance for your Cisco products. Open a case, chat with
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          ...
          other resources for Cisco products.
        </p>
