      ...
      <div className="px-4 md:px-12 py-6 md:py-10 overflow-y-auto no-scrollbar h-full">
        ...
        {active === null && (
          <div className="grid grid-cols-3 gap-10">
            <MenuCard
              img="https://www.KalpTech.com/content/dam/KalpTech-cdc/site/images/header/support-home-penn1_brandlibrary-DSC0318.jpg"
              title="Technical Support"
              text="Get help from KalpTech experts."
              cta="Open a case"
            />
            <MenuCard
              img="https://www.KalpTech.com/content/dam/KalpTech-cdc/site/images/header/support-software-downloads-hatchlibrary-general-gettyPA-KalpTech-1309760275.jpg"
              title="Product Downloads"
              text="Access software and updates."
              cta="Go to downloads"
            />
            <MenuCard
              img="https://www.KalpTech.com/content/dam/KalpTech-cdc/site/images/header/support-licensing-hatchlibrary-security-gettyPA-KalpTech-1518851638.jpg"
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          ...
          tools for all KalpTech products and solutions.
        </p>
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          ...
          troubleshooting resources for all KalpTech products.
        </p>
        <span className="text-blue-600 font-medium">
...
function CommunityView() {
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl font-light mb-4">KalpTech Community & Forums</h2>
        <p className="text-gray-600 mb-6 max-w-2xl">
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          ...
          resources for all KalpTech products.
        </p>
        <span className="text-blue-600 font-medium">
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl">
          ...
          various support channels for your KalpTech products.
        </p>
        <span className="text-blue-600 font-medium">
